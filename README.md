...
Simply open [swatchlab webapp](https://n0acc3ss.github.io/swatch-lab/) The web-app runs completely on the client side with **zero external server dependencies**.
