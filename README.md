...
<span align="center">A modern, high-fidelity static HTML/CSS/JS single-page application (SPA) that acts as a comprehensive color swatch catalog, real-time analyzer, and visual contrast checker.</span>

---

## 🚀 Getting Started

Simply open [swatchlab web-app](https://n0acc3ss.github.io/swatch-lab/) Swatch-lab runs completely on the client side with **zero external server dependencies**.
